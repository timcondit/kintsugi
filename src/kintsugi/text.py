...
ROMAN_LETTERS: dict[str, list[list[tuple[float, float]]]] = {
    ...
    "C": [[(0.9, 0.2), (0.7, 0), (0.3, 0), (0, 0.5), (0.3, 1), (0.7, 1), (0.9, 0.8)]],
    "D": [[(0, 1), (0, 0), (0.5, 0), (0.9, 0.5), (0.5, 1), (0, 1)]],
    "E": [[(0, 1), (0, 0), (0.8, 0)], [(0, 0.5), (0.6, 0.5)], [(0, 1), (0.8, 1)]],
    "F": [[(0, 1), (0, 0), (0.8, 0)], [(0, 0.5), (0.6, 0.5)]],
    "G": [
        [
            (0.9, 0.2),
            (0.7, 0),
    ...
    "K": [[(0, 1), (0, 0)], [(0.8, 1), (0, 0.5), (0.8, 0)]],
    "L": [[(0, 1), (0, 0), (0.8, 0)]],
    "M": [[(0, 0), (0, 1), (0.5, 0.5), (1, 1), (1, 0)]],
    "N": [[(0, 0), (0, 1), (1, 0), (1, 1)]],
    "O": [[(0.2, 0), (0, 0.5), (0.2, 1), (0.8, 1), (1, 0.5), (0.8, 0), (0.2, 0)]],
    "P": [[(0, 0), (0, 1), (0.7, 1), (0.9, 0.8), (0.7, 0.5), (0, 0.5)]],
    "Q": [
        [(0.2, 0), (0, 0.5), (0.2, 1), (0.8, 1), (1, 0.5), (0.8, 0), (0.2, 0)],
        [(0.6, 0.5), (1, 0)],
    ],
    "R": [
        [(0, 0), (0, 1), (0.7, 1), (0.9, 0.8), (0.7, 0.5), (0, 0.5), (0.8, 0.5), (1, 0)]
    ],
    "S": [
        [
            (0.9, 0.2),
    ...
    "1": [[(0.3, 0.2), (0.5, 0), (0.5, 0), (0.5, 1)]],
    "2": [[(0, 0.2), (0.3, 0), (0.7, 0), (1, 0.3), (0, 1), (1, 1)]],
    "3": [
        [
            (0, 0.8),
            (0.4, 0.6),
    ...
    "9": [[(0.2, 1), (0.4, 1), (1, 1), (1, 0.5), (0.8, 0), (0.2, 0), (0.3, 0.5)]],
    "-": [[(0.2, 0.5), (0.8, 0.5)]],
    "/": [[(0.2, 1), (0.8, 0)]],
    '"': [[(0.2, 0.9), (0.2, 0.7)], [(0.8, 0.9), (0.8, 0.7)]],
    "'": [[(0.5, 1), (0.5, 0.7)]],
}
...
class HandTextRenderer:
    ...
    def _wobble_point(self, x: float, y: float, seed: int) -> tuple[float, float]:
    ...
    def render_character(
        self, char: str, x: float, y: float, seed: int = 0
